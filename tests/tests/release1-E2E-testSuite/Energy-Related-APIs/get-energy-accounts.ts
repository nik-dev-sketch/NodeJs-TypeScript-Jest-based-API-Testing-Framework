...
globals.describe('CAT RESI R1 - GET Energy Accounts & Energy Account Detail API Test Suite', () => {
  ...
  globals.test('C&I - GET Customers API 200 & 404 status Codes Test Run', async () => {
