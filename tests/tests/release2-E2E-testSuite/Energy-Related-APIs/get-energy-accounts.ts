...
globals.describe('CAT SME R2 - GET Energy Accounts & Energy Account Detail API Test Suite', () => {
  ...
  globals.test('CAT SME R2 - GET Customers API 200 & 404 status Codes Test Run', async () => {
