...
globals.describe('C&I GET Service Points & Service Point Detail API Test Suite', () => {
  ...
  globals.test('C&I Service Points and Service Point Details 200 OK & 404 Status Code Test Run', async () => {
